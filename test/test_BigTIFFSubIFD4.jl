...
filename = joinpath(testbase, "BigTIFFSubIFD4.tif")
    # $ ScanImageTiffReader image shape BigTIFFSubIFD4.tif
    ...
    # $ ScanImageTiffReader image bytes BigTIFFSubIFD4.tif
    # 24 kB
    ...
    # $ ScanImageTiffReader descriptions --frame 0 BigTIFFSubIFD4.tif
    #
    @test ScanImageTiffReader.open(filename, description, 1) == ""

    # $ ScanImageTiffReader metadata BigTIFFSubIFD4.tif
    #

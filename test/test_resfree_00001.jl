...
filename = joinpath(testbase, "resfree_00001.tif")
    # $ ScanImageTiffReader image shape resfree_00001.tif
    ...
    # $ ScanImageTiffReader image bytes resfree_00001.tif
    # 5 MB
    ...
    # $ ScanImageTiffReader descriptions --frame 0 resfree_00001.tif
    # "frameNumbers = 1" 
    ...
    # $ ScanImageTiffReader metadata resfree_00001.tif

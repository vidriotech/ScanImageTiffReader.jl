...
filename = joinpath(testbase, "res_00001.tif")
    # $ ScanImageTiffReader image shape res_00001.tif
    ...
    # $ ScanImageTiffReader image bytes res_00001.tif
    # 5 MB
    ...
    # $ ScanImageTiffReader descriptions --frame 0 res_00001.tif
    # "frameNumbers = 1" 
    ...
    # $ ScanImageTiffReader metadata res_00001.tif

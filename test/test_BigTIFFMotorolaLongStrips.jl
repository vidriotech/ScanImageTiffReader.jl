...
filename = joinpath(testbase, "BigTIFFMotorolaLongStrips.tif")
    # $ ScanImageTiffReader image shape BigTIFFMotorolaLongStrips.tif
    ...
    # $ ScanImageTiffReader image bytes BigTIFFMotorolaLongStrips.tif
    # 12 kB
    ...
    # $ ScanImageTiffReader descriptions --frame 0 BigTIFFMotorolaLongStrips.tif
    #
    @test ScanImageTiffReader.open(filename, description, 1) == ""

    # $ ScanImageTiffReader metadata BigTIFFMotorolaLongStrips.tif
    #

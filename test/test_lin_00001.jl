...
filename = joinpath(testbase, "lin_00001.tif")
    # $ ScanImageTiffReader image shape lin_00001.tif
    ...
    # $ ScanImageTiffReader image bytes lin_00001.tif
    # 5 MB
    ...
    # $ ScanImageTiffReader descriptions --frame 0 lin_00001.tif
    # "frameNumbers = 1" 
    ...
    @test desc[10] == "epoch = [2016 6 4 13 51 23.061]"

    # $ ScanImageTiffReader metadata lin_00001.tif
